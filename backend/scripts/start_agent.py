#!/usr/bin/env python3
"""
Script to start an agent server.

Usage:
    python start_agent.py --agent <agent_name> [--port <port>]

Example:
    python start_agent.py --agent market_research --port 8004
"""
...
def start_agent(agent_name, port=None):
    ...
    try:
        ...
        agent.run_server(port=agent.port)
...
if __name__ == "__main__":
    args = parse_args()
    success = start_agent(args.agent, args.port)
